...
*/
	@GetMapping("/getPostsByCommunityId")
	@ResponseBody
	public PostServiceResponse getPostList(@RequestParam Long communityId) {
		PostServiceResponse response = new PostServiceResponse();
		response.getResponse().put("postList", postService.getPostsByCommunityId(communityId));
